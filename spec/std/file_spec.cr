...
describe "File" do
      ...
      File.open(__FILE__) do |file1|
        File.open(__FILE__) do |file2|
          file1.flock_exclusive do
            expect_raises(BlockingIOError) do
  ...
  describe "utime" do
    ...
    it "raises if file not found" do
      ...
      expect_raises FileNotFoundError, "Error setting time to file" do
  ...
  describe "touch" do
    ...
    it "raises if path contains non-existent directory" do
      expect_raises FileNotFoundError, "Error opening file" do
        File.touch("/tmp/non/existent/directory/test.tmp")
      end
    end

    it "raises if file cannot be accessed" do
      expect_raises PermissionError, "Operation not permitted" do
        File.touch("/bin/ls")
      end
    end
  end
